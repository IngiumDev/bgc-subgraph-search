...
def count_prots_per_pfam(
        pfam_domains: list[str], client: MongoClient
) -> dict[str, int]:
    """
...
def matches_fg_query(FG_query_pattern: re.Pattern[str], FG_candidate: str) -> bool:
    return FG_query_pattern.search(FG_candidate) is not None
